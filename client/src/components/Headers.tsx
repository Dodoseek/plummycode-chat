...
const Header: FC = async () => {
  ...
  return (
    <>
      <header
        className="rounded-b-md pt-1 border border-violet-400/20 hover:bg-purple-900/20 bg-purple-950/20 backdrop-blur-sm/20 inline-flex items-center justify-center px-4">
...
export const HeaderProfile: FC<UserProps> = ({ name }) => {
  return (
    <>
      <div
        className='mx-1
