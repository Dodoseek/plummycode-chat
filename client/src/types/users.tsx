...
export interface RestrictiveUser extends Omit<User, 'email' | 'dob' | "is_private"> { }

export interface CreateUser extends Omit<RestrictiveUser, "id" | "image" | "slug" | "full_name"> {
    password1: string,
    password2: string,
    email: string
};

export interface AllUsers extends ListData {
    results: RestrictiveUser[]
};
